...
import (
	...
	"github.com/acent/go-acent/signer/fourbyte"
	"github.com/acent/go-acent/signer/rules"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Acent account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func checkFile(filename string) error {
	...
	// https://github.com/acent/go-acent/issues/20123
