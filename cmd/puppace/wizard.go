...
type wizard struct {
	...
	services map[string][]string   // Acent services known to be running on servers
...
// converts it to an Acent address. If an empty line is entered, the default
// value is returned.
