...
import (
	...
	math2 "github.com/acent/go-acent/common/math"
...
// newAlethGenesisSpec converts a go-acent genesis block into a Aleth-specific
// chain specification format.
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	// Only ethash is currently supported between go-acent and aleth
...
type parityChainSpecPricing struct {
	...
	// Before the https://github.com/paritytech/parity-acent/pull/11039,
...
// newParityChainSpec converts a go-acent genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only ethash is currently supported between go-acent and Parity
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	...
	// https://github.com/acent/EIPs/blob/master/EIPS/eip-608.md
	spec.Params.EIP150Transition = hexutil.Uint64(genesis.Config.EIP150Block.Uint64())

	// Spurious Dragon: 155, 160, 161, 170
	// https://github.com/acent/EIPs/blob/master/EIPS/eip-607.md
	...
	spec.Genesis.Seal.Acent.Nonce = types.EncodeNonce(genesis.Nonce)
	spec.Genesis.Seal.Acent.MixHash = genesis.Mixhash[:]
	spec.Genesis.Difficulty = (*hexutil.Big)(genesis.Difficulty)
	spec.Genesis.Author = genesis.Coinbase
	spec.Genesis.Timestamp = (hexutil.Uint64)(genesis.Timestamp)
	spec.Genesis.ParentHash = genesis.ParentHash
...
// pyAcentGenesisSpec represents the genesis specification format used by the
// Python Acent implementation.
type pyAcentGenesisSpec struct {
	Nonce      types.BlockNonce  `json:"nonce"`
	Timestamp  hexutil.Uint64    `json:"timestamp"`
	ExtraData  hexutil.Bytes     `json:"extraData"`
	GasLimit   hexutil.Uint64    `json:"gasLimit"`
...
// newPyAcentGenesisSpec converts a go-acent genesis block into a Parity specific
// chain specification format.
func newPyAcentGenesisSpec(network string, genesis *core.Genesis) (*pyAcentGenesisSpec, error) {
	// Only ethash is currently supported between go-acent and pyacent
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	spec := &pyAcentGenesisSpec{
