...
// setting up a new or managing an existing Acent private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Acent private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Acent network down to  |")
	...
	log.Info("Administering Acent network", "name", w.network)
