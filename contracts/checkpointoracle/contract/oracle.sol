 ...
 * @author Gary Rong<garyrong@acent.org>, Martin Swende <martin.swende@acent.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the acent.
    uint sectionSize;
