...
func makeSealer(genesis *core.Genesis) (*node.Node, *eth.Acent, error) {
	// Define the basic configurations for the Acent node
	...
	// Start the node and configure a full Acent node on it
