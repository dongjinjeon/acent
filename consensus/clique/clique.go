...
// ecrecover extracts the Acent account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Acent address
...
// Acent testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Acent address of the signing key
