...
// mapped from textual names used in the tests below to actual Acent private
...
// address retrieves the Acent address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Acent address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/acent/go-acent/issues/17593). Whilst this
