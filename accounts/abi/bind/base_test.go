...
func (mc *mockCaller) CallContract(ctx context.Context, call acent.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call acent.CallMsg) ([]byte, error) {
