...
type SimulatedBackend struct {
	...
	blockchain *core.BlockChain // Acent blockchain to handle the consensus
...
func (b *SimulatedBackend) TransactionByHash(ctx context.Context, txHash common.Hash) (*types.Transaction, bool, error) {
	...
	return nil, false, acent.NotFound
}
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call acent.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call acent.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call acent.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call acent.CallMsg, block *types.Block, stateDB *state.StateDB) (*core.ExecutionResult, error) {
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query acent.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query acent.FilterQuery, ch chan<- types.Log) (acent.Subscription, error) {
...
func (b *SimulatedBackend) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (acent.Subscription, error) {
