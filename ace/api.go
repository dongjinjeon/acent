...
// NewPublicAcentAPI creates a new Acent protocol API for full nodes.
func NewPublicAcentAPI(e *Acent) *PublicAcentAPI {
	return &PublicAcentAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicAcentAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (api *PublicAcentAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicAcentAPI) Hashrate() hexutil.Uint64 {
	return hexutil.Uint64(api.e.Miner().HashRate())
}

// ChainId is the EIP-155 replay-protection chain id for the current acent chain config.
func (api *PublicAcentAPI) ChainId() (hexutil.Uint64, error) {
...
func NewPublicMinerAPI(e *Acent) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Acent) *PrivateMinerAPI {
...
// admin methods of the Acent service.
func NewPrivateAdminAPI(eth *Acent) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of Acent full node APIs exposed
...
// related public debug methods of the Acent service.
func NewPublicDebugAPI(eth *Acent) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of Acent full node APIs exposed over
...
// private debug methods of the Acent service.
func NewPrivateDebugAPI(eth *Acent) *PrivateDebugAPI {
