...
func (eth *Acent) stateAtBlock(block *types.Block, reexec uint64) (statedb *state.StateDB, release func(), err error) {
...
func (eth *Acent) statesInRange(fromBlock, toBlock *types.Block, reexec uint64) (states []*state.StateDB, release func(), err error) {
...
func (eth *Acent) stateAtTransaction(block *types.Block, txIndex int, reexec uint64) (core.Message, vm.BlockContext, *state.StateDB, func(), error) {
