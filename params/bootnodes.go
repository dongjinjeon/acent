...
import "github.com/acent/go-acent/common"

// MainnetBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main Acent network.
var MainnetBootnodes = []string{
	// Acent Foundation Go Bootnodes
...
// genesis hash and protocol. See https://github.com/acent/discv4-dns-lists for more
// information.
