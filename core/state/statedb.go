...
// Package state provides a caching layer atop the Acent state trie.
package state
...
// StateDB structs within the acent protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/acent/go-acent/pull/16485#issuecomment-380438527),
