...
// Package graphql provides a GraphQL interface to Acent node data.
package graphql
...
// Account represents an Acent account at a particular block.
type Account struct {
...
// Transaction represents an Acent transaction.
...
// Block represents an Acent block.
...
type CallData struct {
	From     *common.Address // The Acent address the call is from.
	To       *common.Address // The Acent address the call is to.
