...
import (
	...
	"github.com/acent/go-acent/p2p/simulations"
	"github.com/acent/go-acent/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	acent, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, acent, &config)
	if err != nil {
		return nil, err
	}
	return acent, nil
